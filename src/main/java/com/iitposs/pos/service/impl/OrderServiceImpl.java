...
public class OrderServiceImpl implements OrderService {
    ...
    public String saveOrder(OrderSaveRequestDTO saveRequestDTO) {
        ...
        Customer customer = customerReo.getReferenceById(saveRequestDTO.getCustomerID());
        ...
        if (orderRepo.existsById(orders.getOrderID())) {
            ...
            List<OrderDetails> orderDetailsList = modelMapper.map(
                    saveRequestDTO.getSaveRequestDTOList(), new TypeToken<List<OrderDetails>>() {
                    }.getType()
            );
            ...
            if (!orderDetailsList.isEmpty()) {
                ...
                return "OrderDetail has been saved...!";
            } else {
